...
// VERIFICAR RESPOSTA (VERSÃO CORRETA COM ENVIO PARA PLANILHA)
...
// FUNÇÃO PARA VER OS ACERTOS DO USUÁRIO
function verAcertosUsuario() {
  const usuario = localStorage.getItem("usuario") || "Anônimo";
  alert(`📊 ${usuario}, você tem ${score} acertos nesta fase!`);
  console.log("👉 Acesse sua planilha do Google para ver todos os resultados!");
}